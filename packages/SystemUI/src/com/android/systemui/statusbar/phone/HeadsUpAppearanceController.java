...
public class HeadsUpAppearanceController implements OnHeadsUpChangedListener,
    ...
    // Cosmic-OS Logo
    private final ImageView mCosmicLogo;
    ...
    private void setShown(boolean isShown) {
        ...
        if (mShown != isShown) {
            ...
            if (isShown) {
                ...
                if (mShowLogo) {
                    CrossFadeHelper.fadeOut(mCosmicLogo, CONTENT_FADE_DURATION/* duration */,
                                0 /* delay */, () -> mCosmicLogo.setVisibility(View.INVISIBLE));
                }
                ...
                if (mShowLogo) {
                    CrossFadeHelper.fadeIn(mCosmicLogo, CONTENT_FADE_DURATION /* duration */,
                                CONTENT_FADE_DELAY /* delay */);
                }
                if (mShowCarrierLabel == 2 || mShowCarrierLabel == 3) {
